...
public enum ModArmorMaterial implements IArmorMaterial {
	DIOPSIDE("diopside", 46, new int[]{5, 10, 12, 5}, 40, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 5.0F, 0.2F, () -> {
		return Ingredient.fromItems(ModItems.DIOPSIDE.get());
	});
	...
	public String getName() {
		return Jurtaplex.MOD_ID + ":" + this.name;
	}
